...
namespace LastDanceMAUI.Model
{
    public class RootWeather
    {
        ...
        public RecordWeather recordWeather { get; set; }

        [JsonPropertyName("Metadata")]
        public MetadataWeather metadataWeather { get; set; }
    }
    ...
    public class Daily
    {
        ...
        public string emojiWeather
        {
            get
            {
                return EmojiHelper.GetEmojiWeather(status);
            }
        }
        ...
        public string todayStatus
        {
            get
            {
                return EmojiHelper.GetEmojiWeather(_todayStatus);
            }
            set
            {
                _todayStatus = value;
